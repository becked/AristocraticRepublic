...
# Mod metadata
MOD_NAME="Aristocratic Republic"
MOD_SUMMARY="Power shared is power contested. Every 10 turns, elevate a new family head to the throne — or keep your current leader, if the other families will allow it."
